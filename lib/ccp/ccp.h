...
bool    CCP_Init ( 
    bool (*callback) ( const uint8_t qID, const uint8_t *payload, const uint16_t payloadLen) ) ;          // This is a callback. Payload buffer is discarded on return.
